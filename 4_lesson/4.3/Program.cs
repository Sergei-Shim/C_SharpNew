//Двум.массив - в одномерный, сост. из среднеарифм. знач. по строкам двум.м.
int[,] CreateMatrix(int rowCount, int columsCount) // Функция создания матрицы с элементами от 1 до 11
{
